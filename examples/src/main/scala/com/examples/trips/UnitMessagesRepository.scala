...
abstract class UnitMessages extends Table[UnitMessages, UnitMessage] {
  object unitId extends StringColumn with PrimaryKey {override val name = "unit_id"}
  object timestamp extends Col[JLocalDateTime] with PartitionKey
  object driverId extends OptionalStringColumn {override val name = "driver_id"}
  ...
  object tripType extends EnumColumn[TripType.Value] {override val name = "trip_type"}
  object fuelLevel extends OptionalDoubleColumn {override val name = "fuel_level"}
}
