...
/**
  ...
  * used in [[ParDataPipeline]]
  *
  * Uses standard [[ForkJoinPool]]
  **/
protected[trembita]
object MergeSort {
...
protected[trembita]
class MergeSort[T: Ordering](val a: Array[T], val helper: Array[T], val lo: Int, val hi: Int) extends RecursiveAction {
